...
def check_latest_version():
    ...
    try:
        ...
        response = requests.get(
            "https://api.github.com/repos/wgqi1126/cursor-free-vip/releases/latest",
            headers=headers,
            timeout=10
        )
        ...
        if is_newer_version_available:
            ...
            try:
                changelog_url = "https://raw.githubusercontent.com/wgqi1126/cursor-free-vip/main/CHANGELOG.md"
            ...
            try:
                ...
                if platform.system() == 'Windows':
                    update_command = 'irm https://raw.githubusercontent.com/wgqi1126/cursor-free-vip/main/scripts/install.ps1 | iex'
                    ...
                    install_script_url = 'https://raw.githubusercontent.com/wgqi1126/cursor-free-vip/main/scripts/install.sh'
