    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(mode="w", encoding="utf-8", errors="ignore", delete=False) as tmp_file:
            ...
            if sys.platform == "win32":
                ...
                CButton_new_pattern = r'$(k,E(Ks,{title:"yeongpin GitHub",size:"small",get codicon(){return F.rocket},get onClick(){return function(){window.open("https://github.com/wgqi1126/cursor-free-vip","_blank")}}}),null)'
                ...
                CButton_new_pattern = r'M(x,I(as,{title:"yeongpin GitHub",size:"small",get codicon(){return $.rocket},get onClick(){return function(){window.open("https://github.com/wgqi1126/cursor-free-vip","_blank")}}}),null)'
